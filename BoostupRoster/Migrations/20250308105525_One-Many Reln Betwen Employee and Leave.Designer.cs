...
namespace Boostup.API.Migrations
{
    ...
    [Migration("20250308105525_One-Many Reln Betwen Employee and Leave")]
    partial class OneManyRelnBetwenEmployeeandLeave
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boostup.API.Entities.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Boostup.API.Entities.EmployeeDetail", b =>
                {
                    b.HasOne("Boostup.API.Entities.User", "User")
                        ...
                        .HasForeignKey("Boostup.API.Entities.EmployeeDetail", "UserId")
            ...
            modelBuilder.Entity("Boostup.API.Entities.Leave", b =>
                {
                    ...
                    b.HasOne("Boostup.API.Entities.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Boostup.API.Entities.User", null)
                        .WithMany()
